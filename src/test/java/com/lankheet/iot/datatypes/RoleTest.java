...
import com.lankheet.iot.datatypes.entities.DomoticsRole;

public class RoleTest {

    @Test
    public void test() {
        DomoticsRole role = new DomoticsRole("admin");
        ...
        assertThat(role.getPermissionFlags(), is(DomoticsRole.ROLE_PERMISSION_CONTROL_FLAG));
        ...
        assertThat(role.getPermissionFlags(), is(DomoticsRole.ROLE_PERMISSION_DELETE_FLAG | DomoticsRole.ROLE_PERMISSION_WRITE_FLAG));
    }
