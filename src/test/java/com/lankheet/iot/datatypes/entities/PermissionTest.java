...
import com.lankheet.iot.datatypes.entities.Permission;
...
public class PermissionTest
{
    ...
    public void test() {
        ...
        assertThat(permission.getPermissionFlags(), is(Permission.ROLE_PERMISSION_CONTROL_FLAG));
        ...
        assertThat(permission.getPermissionFlags(), is(Permission.ROLE_PERMISSION_DELETE_FLAG | Permission.ROLE_PERMISSION_WRITE_FLAG));
    }
